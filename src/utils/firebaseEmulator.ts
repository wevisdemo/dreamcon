...
/**
 * Vite proxies the emulators (see `vite.config.ts`), so the browser SDKs call the page's
 * own origin: localhost in `pnpm dev`, or the public HTTPS URL of the demo image.
